...
- fund it through the Devnet faucet
- construct and sign a System Program transfer
- broadcast the serialized transaction through every configured RPC route
- preserve every acceptance, timeout, HTTP failure, RPC error, and disagreement
- require at least two independent providers to report the signature as confirmed
